...
public class ImageDatabaseSeeder implements CommandLineRunner {
  ...
  public void run(String... args) {
    ...
    String[] imageNames = {
      "toyota_yaris.jpg", "honda_fit.jpg", "toyota_camry.jpg", "honda_accord.jpg", "nissan_altima.jpg",
      "bmw_3series.jpg", "mercedes_cclass.jpg", "audi_a4.jpg", "bmw_x5.jpg", "mercedes_eclass.jpg", "audi_q7.jpg",
      "tesla_model3.jpg", "tesla_modely.jpg", "ford_focus.jpg", "hyundai_elantra.jpg", "kia_sportage.jpg",
      "lexus_rx350.jpg", "vw_passat.jpg"
    };
        ...
        try {
          ...
          try (InputStream is = resource.getInputStream()) {
            MockMultipartFile file = new MockMultipartFile(
              "file", fileName, "image/jpeg", is
            );
            imageService.uploadImage(carId, file);
            log.info("Seeded image for car id={}", carId);
          }
        } catch (Exception e) {
          log.error("Failed to seed image {} for car {}: {}", fileName, carId, e.getMessage());
        }
      }
    }
  }
