...
VALUES
  ...
  -- =====================================================
  ('Ford', 'Focus', 2021, 'ECONOMY', 30.00, 2, 'UNCONFIRMED', 'https://example.com/ford-focus.jpg'),
  ('Hyundai', 'Elantra', 2022, 'COMFORT', 45.00, 2, 'UNCONFIRMED', 'https://example.com/hyundai-elantra.jpg'),
  ...
  ('Volkswagen', 'Passat', 2022, 'BUSINESS', 85.00, 2, 'UNCONFIRMED', 'https://example.com/vw-passat.jpg');
