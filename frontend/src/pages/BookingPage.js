...
const BookingPage = () => {
    ...
    // ВІДПРАВКА БРОНЮВАННЯ (виправлено)
        ...
        <div className={styles.pageContainer}>
            ...
            <form onSubmit={handleSubmit} className={styles.contentGrid}>
                    ...
                    <div className={styles.formSection}>
                        ...
                        <div className={styles.dateRow}>
                            <div className={styles.inputGroup}>
                                ...
                                <input type="date" required value={dates.start} onChange={(e) => setDates({...dates, start: e.target.value})} />
                            </div>
                            <div className={styles.inputGroup}>
                                <label>Завершення оренди</label>
                                <input type="date" required min={dates.start} value={dates.end} onChange={(e) => setDates({...dates, end: e.target.value})} />
                            </div>
                        </div>
                    </div>
                    ...
                    <div className={styles.formSection}>
                        ...
                        <div className={styles.paymentOptions}>
                            <label className={`${styles.paymentOption} ${paymentMethod === 'CARD' ? styles.selected : ''}`}>
                                <input type="radio" checked={paymentMethod === 'CARD'} onChange={() => setPaymentMethod('CARD')} /> 💳 Оплата карткою онлайн
                            </label>
                            <label className={`${styles.paymentOption} ${paymentMethod === 'CASH' ? styles.selected : ''}`}>
                                <input type="radio" checked={paymentMethod === 'CASH'} onChange={() => setPaymentMethod('CASH')} /> 💵 Готівкою при отриманні
                            </label>
                        </div>
                    </div>
                </div>
                ...
                <div className={styles.summaryCard}>
                    ...
                    <div className={styles.totalRow}><span>До сплати:</span><span>{days * car.pricePerDay}€</span></div>
                    <button type="submit" className={styles.confirmBtn}>ПІДТВЕРДИТИ</button>
                </div>
            </form>
        </div>
    );
